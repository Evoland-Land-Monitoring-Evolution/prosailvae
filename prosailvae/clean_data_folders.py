...
def s2_data_files_used():
    ...
    # list file with data
    list_data_used_ = [
        glob.glob("/home/uz/vinascj/scratch/fork2/prosailvae/field_data/processed/before*csv")+
        glob.glob("/home/uz/vinascj/scratch/fork2/prosailvae/field_data/processed/after*csv")
    ]
    # flatten list
    ...
    for idx, elemnt in enumerate(list_data_used):
        ...
        # filter
        s2_filenames_l.append(
            interest_df["s2_filenames"]
        )
...
def maestria_data_files_available():
    ...
    """
    # list s2 products
    maestria_folder = glob.glob("/work/CESBIO/projects/MAESTRIA/prosail_validation/validation_sites/T*/*.tif")
    # convert to df
