...
def convert_prosail_data_set_from_weiss(nb_simus=2048, noise=0, psimulator=None, ssimulator=None, 
    ...
    s2_r_weiss, prosail_vars_weiss = load_weiss_dataset(os.path.join(prosailvae.__path__[0], os.pardir) + "/field_data/lai/", 
                                                  mode="pvae", psoil0=0.3)
    s2_r_snap, prosail_vars_snap = load_weiss_dataset(os.path.join(prosailvae.__path__[0], os.pardir) + "/field_data/lai/", 
                                                 mode="snap", psoil0=0.3)
