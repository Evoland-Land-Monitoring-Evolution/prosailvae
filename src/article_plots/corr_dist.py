...
def plot_lai_correlation():
    ...
    V_corr_v2 = correlate_with_lai_V2(
        lai_grid,
        V_grid,
        Vmin_0,
        Vmax_0,
    ...
    V_corr_v2_no_thresh = correlate_with_lai_V2(
        lai_grid,
        V_grid,
        Vmin_0,
        Vmax_0,
    ...
    ax.set_ylabel("V*")
    ax.set_xticks(
        [lai_min, lai_thresh, lai_max], ["0", "$LAI_{thresh}$", "$LAI_{max}$"]
    )
    ax.set_yticks(
        [Vmin_0, V_min_lai_thresh, Vmin_lai_max, Vmax_lai_max, Vmax_0],
    ...
    ax.set_yticks(
        [Vmin_0, Vmin_lai_max, Vmax_lai_max, Vmax_0],
    ...
    ax.set_ylabel("V*")
    ax.set_xticks(
        [lai_min, lai_true_max, lai_conv, lai_max],
        ["0", "$LAI_{True max}$", "$C_{LAI}$", "$LAI_{max}$"],
    )
    ax.set_yticks([Vmin_0, V_mean, Vmax_0], ["$V_{l,0}$", r"$\mu_V$", "$V_{u,0}$"])
