...
def plot_frm4veg_validation_patch(
    ...
    df_sns_plot["Land Cover"] = df_sns_plot["Land Cover"].apply(
        lambda x: "Rapeseed" if x == "Rappesed" else x
    )
...
frm4veg_data_dir = (
    "/home/yoel/Documents/Dev/PROSAIL-VAE/prosailvae/data/frm4veg_2021_validation"
)
frm4veg_barrax_filename = "2B_20210722_FRM_Veg_Barrax_20210719"
frm4veg_wytham_filename = "2A_20180629_FRM_Veg_Wytham_20180703"
gdf_barrax_lai, s2_r_barrax, _, _, _ = load_frm4veg_data(
    frm4veg_data_dir, frm4veg_barrax_filename, variable="lai"
)
fig, ax = plot_frm4veg_validation_patch(
    gdf_barrax_lai, s2_r_barrax, variable="lai", legend_columns=3
)
tikzplotlib_fix_ncols(fig)
tikzplotlib.save("test.tex")
fig.savefig(frm4veg_data_dir + "/barrax_site_2021.svg")
gdf_wytham_lai, s2_r_wytham, _, _, _ = load_frm4veg_data(
    frm4veg_data_dir, frm4veg_wytham_filename, variable="lai"
)
fig, ax = plot_frm4veg_validation_patch(
    gdf_wytham_lai, s2_r_wytham, variable="lai", legend_columns=2
)
