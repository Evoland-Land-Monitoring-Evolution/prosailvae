...
def main():
    ...
    belsar_pred_dir = (
        "/home/yoel/Documents/Dev/PROSAIL-VAE/prosailvae/results/bvnet_belsar_pred/"
    )
    ...
    df_results_lai = get_belsar_x_frm4veg_lai_results(
        belsar_results,
        barrax_results,
        barrax_2021_results,
        wytham_results,
    ...
    rmse_lai, mpiw_lai, picp_lai, _ = get_validation_global_metrics(
        df_results_lai, decompose_along_columns=["Campaign"], variable="lai"
    )
    ...
    df_results_ccc = get_frm4veg_ccc_results(
        barrax_results,
        barrax_2021_results,
        wytham_results,
        frm4veg_ccc="ccc",
    ...
    tikzplotlib_fix_ncols(fig)
    tikzplotlib.save(os.path.join(res_dir, f"bvnet_{variable}_regression_campaign.tex"))
    rmse_ccc, mpiw_ccc, picp_ccc, _ = get_validation_global_metrics(
        df_results_ccc, decompose_along_columns=["Campaign"], variable="ccc"
    )
