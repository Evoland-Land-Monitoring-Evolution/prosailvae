...
#     save_metrics,
# )
from .prosail_plots import (  # PROSAIL_2D_aggregated_results,; PROSAIL_2D_article_plots,; PROSAIL_2D_res_plots,; article_2D_aggregated_results,
    all_loss_curve,
    frm4veg_plots,
    loss_curve,
    pair_plot,
...
#                 os.path.join(
#                     scatter_dir[variable],
#                     f"{model_name}_{variable}_pvae_vs_snap_regression_campaign_land_cover.png",
#                 )
#             )
#             tikzplotlib_fix_ncols(fig)
#             tikzplotlib.save(
#                 os.path.join(
#                     scatter_dir[variable],
#                     f"{model_name}_{variable}_pvae_vs_snap_regression_campaign_land_cover.tex",
#                 )
#             )
...
#                 os.path.join(
#                     scatter_dir[variable],
#                     f"{model_name}_{variable}_error_vs_reconstruction_error_land_cover.png",
#                 )
#             )
...
#                 os.path.join(
#                     scatter_dir[variable],
#                     f"{model_name}_{variable}_error_vs_reconstruction_error_Campaign.png",
#                 )
#             )
#             plt.close("all")
