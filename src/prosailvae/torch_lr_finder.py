#!/usr/bin/env python3
"""
Created on Tue Nov 29 09:29:06 2022
...
class LRFinder:
    ...
    def _train_batch(
        self, train_iter, accumulation_steps, non_blocking_transfer=True, n_samples=20
    ):
        self.model.train()
    ...
    def suggest_lr(self):
        ...
        if min_grad_idx is not None:
            ...
            raise NotImplementedError("No LR returned")
...
def get_prosailvae_train_parser():
    ...
    parser.add_argument(
        "-w", dest="weiss_mode", help="remove B2 and B8", type=bool, default=False
    )
...
if __name__ == "__main__":
    ...
    prosail_VAE = get_prosail_VAE(
        ...
        device=device,
        refl_norm_mean=norm_mean,
        refl_norm_std=norm_std,
